    ...
    >
      ...
      <div className='bg-white p-12 rounded-2xl shadow-xl max-w-4xl mx-auto mb-20'>
        <blockquote className='text-center'>
          <p className='text-4xl md:text-3xl text-[#5C4033] mb-6 leading-relaxed font-p font-bold'>
            한 올의 실은 약하지만,
            <br />
            함께 엮이면 그 무엇보다 강해집니다
          </p>
          <footer className='text-lg text-[#8B7355] font-pretendard'>
            — Weave의 핵심 가치
          </footer>
        </blockquote>
      </div>
          ...
          <div className='relative order-2 md:order-1'>
            <div className='space-y-6'>
              {values.map((value, index) => (
                ...
                >
                  <h3
                    className='text-2xl mb-2 font-p font-black'
